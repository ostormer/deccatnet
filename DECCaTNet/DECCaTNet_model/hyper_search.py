...
def hyper_search(all_params, global_params):
    ...
    if global_params['n_gpu']>0:
        trainable = tune.with_resources(hyper_search_train,resources={'gpu':0.45, 'cpu':math.floor(global_params['n_jobs']/(2*global_params['n_gpu'])),"accelerator_type:V100": 1.1})
    else:
